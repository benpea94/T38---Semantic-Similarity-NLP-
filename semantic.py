...
"""
cat and monkey have a decent similarity probably because they are both animals, likewise with apple and banana as they
are both fruits.  Interestingly monkey has a decent similarity to banana perhaps because monkeys are famous for liking
bananas, almost double the similarity than with apple.
"""

sentence_to_compare = "Why is my cat on the car"

sentences = ["where do my do go", "Hello, there is my car", "I\'ve lost my car in my car", "I\'d like my boat back",
...
"""
When running with 'en_core_sm' the similarity index reduces as 'en_core_sm' is not as accurate as 'en_core_md' as it has
no word vectors loaded.
"""